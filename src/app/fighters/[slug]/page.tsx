    ...
    <main className="bg-[#0a0a0a] min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-end pt-12 pb-16">
            ...
            <div className="relative flex justify-center md:justify-start">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-64 h-64 bg-[#c41e3a]/20 rounded-full blur-3xl" />
              </div>
              <img
                src={fighter.image}
                alt={fighter.name}
                className="relative w-80 h-96 object-cover object-top"
          ...
          {fighter.gallery.map((src, i) => (
            ...
            >
              ...
              <div className="absolute top-3 left-3 pointer-events-none">
                <span className="font-heading font-bold text-2xl sm:text-3xl text-white/30">
      ...
      <section className="relative overflow-hidden py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="font-heading font-bold text-[12vw] uppercase text-white opacity-[0.04] leading-none whitespace-nowrap pointer-events-none select-none">
            {fighter.name}
          </span>
        </div>
      </section>
