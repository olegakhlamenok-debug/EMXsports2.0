...
export default function Shop() {
  return (
    <section id="shop" className="relative py-20 sm:py-28 bg-white overflow-hidden">
      <div className="absolute inset-x-0 top-20 sm:top-28 flex items-center justify-center pointer-events-none select-none h-16 sm:h-20">
        <span className="font-heading font-bold uppercase text-gray-900 opacity-[0.08] text-[6vw] leading-none whitespace-nowrap">SHOP</span>
      </div>
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-10 sm:mb-14 text-center">
          ...
          <Link
            href="/shop/"
            className="inline-block text-gray-600 hover:text-gray-900 font-heading text-xs tracking-[0.2em] uppercase transition-colors mt-4"
          >
            View All →
          </Link>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {products.map((product) => (
            <Link
              key={product.name}
              href="/shop/"
              className="group block bg-gray-50 transition-all duration-500 shadow-md hover:shadow-xl hover:-translate-y-2 rounded"
            >
              {/* Product image */}
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="text-gray-600 font-heading text-xs sm:text-sm mb-3 sm:mb-4">
                  {product.price}
                </div>
