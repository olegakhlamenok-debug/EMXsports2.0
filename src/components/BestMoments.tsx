...
export default function BestMoments() {
  ...
  return (
    <>
      <section id="best-moments" className="relative pt-20 sm:pt-28 pb-10 sm:pb-14 bg-[#0a0a0a] overflow-hidden">
        <div className="absolute inset-x-0 top-20 sm:top-28 flex items-center justify-center pointer-events-none select-none h-16 sm:h-20">
          <span className="font-heading font-bold uppercase text-white opacity-[0.08] text-[6vw] leading-none whitespace-nowrap">MOMENTS</span>
        </div>
