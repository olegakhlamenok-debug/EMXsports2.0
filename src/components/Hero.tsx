...
export default function Hero() {
  return (
    <section className="relative flex items-center justify-center overflow-hidden py-16 sm:py-20 md:py-24">
      ...
      {/* Vertical side text */}
      <div
        className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-10 pointer-events-none select-none"
        style={{ writingMode: "vertical-rl", transform: "translateY(-50%) rotate(180deg)" }}
      >
        <span className="text-gray-800 text-6xl sm:text-7xl font-heading uppercase tracking-widest opacity-20 whitespace-nowrap">
